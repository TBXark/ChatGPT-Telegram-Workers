const prompts = [
  {
    ...
    prompt:
      "I have a large set of health data that includes variables such as age, blood pressure, cholesterol levels, and physical activity metrics. I'm having trouble identifying patterns and correlations in the data. Can you provide any advice or methods to help analyze this data more effectively?",
  },
  {
    img: "static/icons/language.png",
    title: "Language Learning Companion",
    description: "Create an AI language learning companion that assists users in improving their language skills.",
    prompt: "Act like a Language Learning Companion. The user is trying to learn a foreign language and they're struggling with the conjugation of the verb 'estar'. Please explain its conjugation in present tense and give a few examples of its usage in sentences.",
  },
  {
  ...
  },
  {
    ...
    prompt: "Act like a Business Developer. The user is a small online retailer specializing in handmade crafts. They want to find potential partnerships to expand their business. Provide them with a plan to identify, approach, and negotiate with potential partners.",
  },
  {
