...
class UserConfig {
  constructor() {
    __publicField(this, "DEFINE_KEYS", []);
    __publicField(this, "AI_PROVIDER", "auto");
    __publicField(this, "AI_IMAGE_PROVIDER", "auto");
    __publicField(this, "SYSTEM_INIT_MESSAGE", null);
    __publicField(this, "SYSTEM_INIT_MESSAGE_ROLE", "system");
    __publicField(this, "OPENAI_API_KEY", []);
    __publicField(this, "OPENAI_CHAT_MODEL", "gpt-4o-mini");
    __publicField(this, "OPENAI_API_BASE", "https://api.openai.com/v1");
    __publicField(this, "OPENAI_API_EXTRA_PARAMS", {});
    __publicField(this, "DALL_E_MODEL", "dall-e-2");
    __publicField(this, "DALL_E_IMAGE_SIZE", "512x512");
    __publicField(this, "DALL_E_IMAGE_QUALITY", "standard");
    __publicField(this, "DALL_E_IMAGE_STYLE", "vivid");
    __publicField(this, "AZURE_API_KEY", null);
    __publicField(this, "AZURE_COMPLETIONS_API", null);
    __publicField(this, "AZURE_DALLE_API", null);
    __publicField(this, "CLOUDFLARE_ACCOUNT_ID", null);
    __publicField(this, "CLOUDFLARE_TOKEN", null);
    __publicField(this, "WORKERS_CHAT_MODEL", "@cf/mistral/mistral-7b-instruct-v0.1 ");
    __publicField(this, "WORKERS_IMAGE_MODEL", "@cf/stabilityai/stable-diffusion-xl-base-1.0");
    __publicField(this, "GOOGLE_API_KEY", null);
    __publicField(this, "GOOGLE_COMPLETIONS_API", "https://generativelanguage.googleapis.com/v1beta/models/");
    __publicField(this, "GOOGLE_COMPLETIONS_MODEL", "gemini-pro");
    __publicField(this, "MISTRAL_API_KEY", null);
    __publicField(this, "MISTRAL_API_BASE", "https://api.mistral.ai/v1");
    __publicField(this, "MISTRAL_CHAT_MODEL", "mistral-tiny");
    __publicField(this, "COHERE_API_KEY", null);
    __publicField(this, "COHERE_API_BASE", "https://api.cohere.com/v1");
    __publicField(this, "COHERE_CHAT_MODEL", "command-r-plus");
    __publicField(this, "ANTHROPIC_API_KEY", null);
    __publicField(this, "ANTHROPIC_API_BASE", "https://api.anthropic.com/v1");
    __publicField(this, "ANTHROPIC_CHAT_MODEL", "claude-3-haiku-20240307");
  }
}
class Environment {
  constructor() {
    __publicField(this, "BUILD_TIMESTAMP", 1724070470);
    __publicField(this, "BUILD_VERSION", "5119b21");
    __publicField(this, "I18N", null);
    __publicField(this, "LANGUAGE", "zh-cn");
    __publicField(this, "UPDATE_BRANCH", "master");
    __publicField(this, "CHAT_COMPLETE_API_TIMEOUT", 0);
    __publicField(this, "TELEGRAM_API_DOMAIN", "https://api.telegram.org");
    __publicField(this, "TELEGRAM_AVAILABLE_TOKENS", []);
    __publicField(this, "DEFAULT_PARSE_MODE", "Markdown");
    __publicField(this, "TELEGRAM_MIN_STREAM_INTERVAL", 0);
    __publicField(this, "TELEGRAM_PHOTO_SIZE_OFFSET", 1);
    __publicField(this, "TELEGRAM_IMAGE_TRANSFER_MODE", "url");
    __publicField(this, "I_AM_A_GENEROUS_PERSON", false);
    __publicField(this, "CHAT_WHITE_LIST", []);
    __publicField(this, "LOCK_USER_CONFIG_KEYS", ["OPENAI_API_BASE", "GOOGLE_COMPLETIONS_API", "MISTRAL_API_BASE", "COHERE_API_BASE", "ANTHROPIC_API_BASE", "AZURE_COMPLETIONS_API", "AZURE_DALLE_API"]);
    __publicField(this, "TELEGRAM_BOT_NAME", []);
    __publicField(this, "CHAT_GROUP_WHITE_LIST", []);
    __publicField(this, "GROUP_CHAT_BOT_ENABLE", true);
    __publicField(this, "GROUP_CHAT_BOT_SHARE_MODE", true);
    __publicField(this, "AUTO_TRIM_HISTORY", true);
    __publicField(this, "MAX_HISTORY_LENGTH", 20);
    __publicField(this, "MAX_TOKEN_LENGTH", -1);
    __publicField(this, "HISTORY_IMAGE_PLACEHOLDER", null);
    __publicField(this, "HIDE_COMMAND_BUTTONS", []);
    __publicField(this, "SHOW_REPLY_BUTTON", false);
    __publicField(this, "EXTRA_MESSAGE_CONTEXT", false);
    __publicField(this, "TELEGRAPH_ENABLE", false);
    __publicField(this, "STREAM_MODE", true);
    __publicField(this, "SAFE_MODE", true);
    __publicField(this, "DEBUG_MODE", false);
    __publicField(this, "DEV_MODE", false);
    __publicField(this, "USER_CONFIG", new UserConfig());
  }
}
...
const CONST = { PASSWORD_KEY: "chat_history_password", GROUP_TYPES: ["group", "supergroup"] };
const ENV_TYPES = { SYSTEM_INIT_MESSAGE: "string", AZURE_API_KEY: "string", AZURE_COMPLETIONS_API: "string", AZURE_DALLE_API: "string", CLOUDFLARE_ACCOUNT_ID: "string", CLOUDFLARE_TOKEN: "string", GOOGLE_API_KEY: "string", MISTRAL_API_KEY: "string", COHERE_API_KEY: "string", ANTHROPIC_API_KEY: "string", HISTORY_IMAGE_PLACEHOLDER: "string" };
const ENV_KEY_MAPPER = { CHAT_MODEL: "OPENAI_CHAT_MODEL", API_KEY: "OPENAI_API_KEY", WORKERS_AI_MODEL: "WORKERS_CHAT_MODEL" };
...
function migrateOldEnv(env, i18n2) {
  ...
  if (!ENV.USER_CONFIG.SYSTEM_INIT_MESSAGE) {
    ENV.USER_CONFIG.SYSTEM_INIT_MESSAGE = ((_b = (_a = ENV.I18N) == null ? void 0 : _a.env) == null ? void 0 : _b.system_init_message) || "You are a helpful assistant";
  }
}
...
class ShareContext {
  constructor() {
    __publicField(this, "currentBotId", null);
    __publicField(this, "currentBotToken", null);
    __publicField(this, "currentBotName", null);
    __publicField(this, "chatHistoryKey", null);
    __publicField(this, "chatLastMessageIdKey", null);
    __publicField(this, "configStoreKey", null);
    __publicField(this, "groupAdminKey", null);
    __publicField(this, "usageKey", null);
    __publicField(this, "chatType", null);
    __publicField(this, "chatId", null);
    __publicField(this, "speakerId", null);
    __publicField(this, "extraMessageContext", null);
    __publicField(this, "allMemberAreAdmin", false);
  }
}
class CurrentChatContext {
  constructor() {
    __publicField(this, "chat_id", null);
    __publicField(this, "reply_to_message_id", null);
    __publicField(this, "parse_mode", ENV.DEFAULT_PARSE_MODE);
    __publicField(this, "message_id", null);
    __publicField(this, "reply_markup", null);
    __publicField(this, "allow_sending_without_reply", null);
    __publicField(this, "disable_web_page_preview", null);
  }
}
class Context {
  constructor() {
    __publicField(this, "USER_CONFIG", new UserConfig());
    __publicField(this, "CURRENT_CHAT_CONTEXT", new CurrentChatContext());
    __publicField(this, "SHARE_CONTEXT", new ShareContext());
  }
  ...
  async _initShareContext(message) {
    ...
    const id = (_a = message == null ? void 0 : message.chat) == null ? void 0 : _a.id;
    ...
    if (CONST.GROUP_TYPES.includes((_b = message.chat) == null ? void 0 : _b.type)) {
    ...
    if (((_c = message == null ? void 0 : message.chat) == null ? void 0 : _c.is_forum) && (message == null ? void 0 : message.is_topic_message)) {
      if (message == null ? void 0 : message.message_thread_id) {
    ...
    this.SHARE_CONTEXT.chatType = (_d = message.chat) == null ? void 0 : _d.type;
    this.SHARE_CONTEXT.chatId = message.chat.id;
    this.SHARE_CONTEXT.speakerId = message.from.id || message.chat.id;
    this.SHARE_CONTEXT.allMemberAreAdmin = (_e = message == null ? void 0 : message.chat) == null ? void 0 : _e.all_members_are_administrators;
  }
  async initContext(message) {
    var _a, _b;
    const chatId = (_a = message == null ? void 0 : message.chat) == null ? void 0 : _a.id;
    const replyId = CONST.GROUP_TYPES.includes((_b = message.chat) == null ? void 0 : _b.type) ? message.message_id : null;
...
class Cache {
  ...
  set(key, value) {
    this.trim();
    this.cache[key] = { value, time: Date.now() };
  }
  get(key) {
    var _a;
    this.trim();
    return (_a = this.cache[key]) == null ? void 0 : _a.value;
  }
  trim() {
...
async function imageToBase64String(url) {
  ...
  return { data: base64String, format: `image/${format}` };
}
...
function makeResponse200(resp) {
  ...
  if (resp.status === 200) {
    ...
    return new Response(resp.body, { status: 200, headers: { "Original-Status": resp.status, ...resp.headers } });
  }
}
...
async function sendTelegramRequest(method, token, body = null) {
  ...
  return fetch(`${ENV.TELEGRAM_API_DOMAIN}/bot${token}/${method}`, { method: "POST", headers, body: body && (body instanceof FormData ? body : JSON.stringify(body)) });
}
async function sendMessage(message, token, context) {
  ...
  if (context == null ? void 0 : context.message_id) {
...
async function sendChatActionToTelegram(action, token, chatId) {
  return sendTelegramRequest("sendChatAction", token, { chat_id: chatId, action });
}
...
async function getChatAdministrators(chatId, token) {
  return sendTelegramRequest("getChatAdministrators", token, { chat_id: chatId }).then((res) => res.json()).catch(() => null);
}
async function getBotName(token) {
  const { result: { username } } = await sendTelegramRequest("getMe", token).then((res) => res.json());
  return username;
}
async function getFileLink(fileId, token) {
  try {
    const { result: { file_path } } = await sendTelegramRequest("getFile", token, { file_id: fileId }).then((res) => res.json());
...
function fixOpenAICompatibleOptions(options) {
  ...
  options.contentExtractor = options.contentExtractor || function(d) {
    var _a, _b, _c;
    return (_c = (_b = (_a = d == null ? void 0 : d.choices) == null ? void 0 : _a[0]) == null ? void 0 : _b.delta) == null ? void 0 : _c.content;
  };
  options.fullContentExtractor = options.fullContentExtractor || function(d) {
    var _a, _b;
    return (_b = (_a = d.choices) == null ? void 0 : _a[0]) == null ? void 0 : _b.message.content;
  };
  options.errorExtractor = options.errorExtractor || function(d) {
    var _a;
    return (_a = d.error) == null ? void 0 : _a.message;
  };
  return options;
}
...
async function requestChatCompletions(url, header, body, context, onStream, onResult = null, options = null) {
  ...
  const resp = await fetch(url, { method: "POST", headers: header, body: JSON.stringify(body), signal });
  if (timeoutID) {
...
ERROR: ${e.message}`;
  ...
  try {
    await (onResult == null ? void 0 : onResult(result));
...
async function renderOpenAIMessage(item) {
  const res = { role: item.role, content: item.content };
  if (item.images && item.images.length > 0) {
    ...
    for (const image of item.images) {
      switch (ENV.TELEGRAM_IMAGE_TRANSFER_MODE) {
        case "base64":
          res.content.push({ type: "image_url", image_url: { url: renderBase64DataURI(await imageToBase64String(image)) } });
          break;
        case "url":
        default:
...
async function requestCompletionsFromOpenAI(params, context, onStream) {
  ...
  const header = { "Content-Type": "application/json", Authorization: `Bearer ${openAIKeyFromContext(context)}` };
  ...
  const body = { model: context.USER_CONFIG.OPENAI_CHAT_MODEL, ...context.USER_CONFIG.OPENAI_API_EXTRA_PARAMS, messages: await Promise.all(messages.map(renderOpenAIMessage)), stream: onStream != null };
...
async function requestImageFromOpenAI(prompt, context) {
  ...
  const header = { "Content-Type": "application/json", Authorization: `Bearer ${openAIKeyFromContext(context)}` };
  const body = { prompt, n: 1, size: context.USER_CONFIG.DALL_E_IMAGE_SIZE, model: context.USER_CONFIG.DALL_E_MODEL };
  if (body.model === "dall-e-3") {
    body.quality = context.USER_CONFIG.DALL_E_IMAGE_QUALITY;
    body.style = context.USER_CONFIG.DALL_E_IMAGE_STYLE;
  }
  const resp = await fetch(url, { method: "POST", headers: header, body: JSON.stringify(body) }).then((res) => res.json());
  if ((_a = resp.error) == null ? void 0 : _a.message) {
    throw new Error(resp.error.message);
  }
  return (_c = (_b = resp == null ? void 0 : resp.data) == null ? void 0 : _b[0]) == null ? void 0 : _c.url;
}
async function run(model, body, id, token) {
  return await fetch(`https://api.cloudflare.com/client/v4/accounts/${id}/ai/run/${model}`, { headers: { Authorization: `Bearer ${token}` }, method: "POST", body: JSON.stringify(body) });
}
...
async function requestCompletionsFromWorkersAI(params, context, onStream) {
  ...
  const body = { messages: messages.map(renderWorkerAIMessage), stream: onStream !== null };
  const options = {};
  options.contentExtractor = function(data) {
    return data == null ? void 0 : data.response;
  };
  options.fullContentExtractor = function(data) {
    var _a;
    return (_a = data == null ? void 0 : data.result) == null ? void 0 : _a.response;
  };
  options.errorExtractor = function(data) {
    var _a, _b;
    return (_b = (_a = data == null ? void 0 : data.errors) == null ? void 0 : _a[0]) == null ? void 0 : _b.message;
  };
...
const GEMINI_ROLE_MAP = { assistant: "model", system: "user", user: "user" };
function renderGeminiMessage(item) {
  return { role: GEMINI_ROLE_MAP[item.role], parts: [{ text: item.content || "" }] };
}
async function requestCompletionsFromGeminiAI(params, context, onStream) {
  ...
  try {
    ...
    throw new Error(((_a = data == null ? void 0 : data.error) == null ? void 0 : _a.message) || JSON.stringify(data));
  }
}
...
async function requestCompletionsFromMistralAI(params, context, onStream) {
  ...
  const header = { "Content-Type": "application/json", Authorization: `Bearer ${context.USER_CONFIG.MISTRAL_API_KEY}` };
  const messages = [...history || [], { role: "user", content: message }];
  if (prompt) {
    messages.unshift({ role: context.USER_CONFIG.SYSTEM_INIT_MESSAGE_ROLE, content: prompt });
  }
  const body = { model: context.USER_CONFIG.MISTRAL_CHAT_MODEL, messages: messages.map(renderMistralMessage), stream: onStream != null };
  return requestChatCompletions(url, header, body, context, onStream);
}
function isCohereAIEnable(context) {
  return !!context.USER_CONFIG.COHERE_API_KEY;
}
const COHERE_ROLE_MAP = { assistant: "CHATBOT", user: "USER" };
function renderCohereMessage(item) {
  return { role: COHERE_ROLE_MAP[item.role], content: item.content };
}
async function requestCompletionsFromCohereAI(params, context, onStream) {
  const { message, prompt, history } = params;
  const url = `${context.USER_CONFIG.COHERE_API_BASE}/chat`;
  const header = { Authorization: `Bearer ${context.USER_CONFIG.COHERE_API_KEY}`, "Content-Type": "application/json", Accept: onStream !== null ? "text/event-stream" : "application/json" };
  const body = { message, model: context.USER_CONFIG.COHERE_CHAT_MODEL, stream: onStream != null, preamble: prompt, chat_history: history.map(renderCohereMessage) };
  if (!body.preamble) {
  ...
  options.contentExtractor = function(data) {
    return data == null ? void 0 : data.text;
  };
  options.fullContentExtractor = function(data) {
    return data == null ? void 0 : data.text;
  };
  options.errorExtractor = function(data) {
    return data == null ? void 0 : data.message;
  };
  return requestChatCompletions(url, header, body, context, onStream, null, options);
}
...
async function renderAnthropicMessage(item) {
  ...
  if (item.images && item.images.length > 0) {
    ...
    for (const image of item.images) {
      res.content.push(await imageToBase64String(image).then(({ format, data }) => ({ type: "image", source: { type: "base64", media_type: format, data } })));
    }
  }
  return res;
}
async function requestCompletionsFromAnthropicAI(params, context, onStream) {
  ...
  const header = { "x-api-key": context.USER_CONFIG.ANTHROPIC_API_KEY, "anthropic-version": "2023-06-01", "content-type": "application/json" };
  const messages = [...history || [], { role: "user", content: message, images }];
  if (messages.length > 0 && messages[0].role === "assistant") {
    messages.shift();
  }
  const body = { system: prompt, model: context.USER_CONFIG.ANTHROPIC_CHAT_MODEL, messages: await Promise.all(messages.map(renderAnthropicMessage)), stream: onStream != null, max_tokens: ENV.MAX_TOKEN_LENGTH > 0 ? ENV.MAX_TOKEN_LENGTH : 2048 };
  if (!body.system) {
    delete body.system;
  }
  const options = {};
  ...
  options.contentExtractor = function(data) {
    var _a;
    return (_a = data == null ? void 0 : data.delta) == null ? void 0 : _a.text;
  };
  options.fullContentExtractor = function(data) {
    var _a;
    return (_a = data == null ? void 0 : data.content) == null ? void 0 : _a[0].text;
  };
  options.errorExtractor = function(data) {
    var _a;
    return (_a = data == null ? void 0 : data.error) == null ? void 0 : _a.message;
  };
  return requestChatCompletions(url, header, body, context, onStream, null, options);
}
...
async function requestCompletionsFromAzureOpenAI(params, context, onStream) {
  ...
  const header = { "Content-Type": "application/json", "api-key": azureKeyFromContext(context) };
  const messages = [...history || [], { role: "user", content: message, images }];
  if (prompt) {
    messages.unshift({ role: context.USER_CONFIG.SYSTEM_INIT_MESSAGE_ROLE, content: prompt });
  }
  const body = { ...context.USER_CONFIG.OPENAI_API_EXTRA_PARAMS, messages: await Promise.all(messages.map(renderOpenAIMessage)), stream: onStream != null };
  return requestChatCompletions(url, header, body, context, onStream);
}
async function requestImageFromAzureOpenAI(prompt, context) {
  ...
  const header = { "Content-Type": "application/json", "api-key": azureKeyFromContext(context) };
  const body = { prompt, n: 1, size: context.USER_CONFIG.DALL_E_IMAGE_SIZE, style: context.USER_CONFIG.DALL_E_IMAGE_STYLE, quality: context.USER_CONFIG.DALL_E_IMAGE_QUALITY };
...
const imageGenAgents = [{ name: "azure", enable: isAzureImageEnable, request: requestImageFromAzureOpenAI }, { name: "openai", enable: isOpenAIEnable, request: requestImageFromOpenAI }, { name: "workers", enable: isWorkersAIEnable, request: requestImageFromWorkersAI }];
...
async function requestCompletionsFromLLM(params, context, llm, modifier, onStream) {
  ...
  const llmParams = { ...params, history, prompt: context.USER_CONFIG.SYSTEM_INIT_MESSAGE };
...
async function chatWithLLM(params, context, modifier) {
  ...
  try {
    ...
    const llm = (_a = loadChatLLM(context)) == null ? void 0 : _a.request;
    if (llm === null) {
...
async function getChatRoleWithContext(context) {
  const { chatId, speakerId, groupAdminKey, currentBotToken: token, allMemberAreAdmin } = context.SHARE_CONTEXT;
  ...
  if (!groupAdmin || !Array.isArray(groupAdmin) || groupAdmin.length === 0) {
    ...
    groupAdmin = result;
    await DATABASE.put(groupAdminKey, JSON.stringify(groupAdmin), { expiration: Date.now() / 1e3 + 120 });
  }
...
const commandAuthCheck = { default(chatType) {
...
async function commandGenerateImg(message, command, subcommand, context) {
  ...
  try {
    const gen = (_a = loadImageGen(context)) == null ? void 0 : _a.request;
    if (!gen) {
...
async function commandCreateNewChatContext(message, command, subcommand, context) {
  try {
    ...
    if (ENV.SHOW_REPLY_BUTTON && !CONST.GROUP_TYPES.includes(context.SHARE_CONTEXT.chatType)) {
      context.CURRENT_CHAT_CONTEXT.reply_markup = { keyboard: [[{ text: "/new" }, { text: "/redo" }]], selective: true, resize_keyboard: true, one_time_keyboard: false };
    } else {
...
async function commandUpdateUserConfigs(message, command, subcommand, context) {
  try {
    ...
    context.USER_CONFIG.DEFINE_KEYS = Array.from(new Set(context.USER_CONFIG.DEFINE_KEYS));
    await DATABASE.put(context.SHARE_CONTEXT.configStoreKey, JSON.stringify(trimUserConfig(trimUserConfig(context.USER_CONFIG))));
    return sendMessageToTelegramWithContext(context)("Update user config success");
  } catch (e) {
    return sendMessageToTelegramWithContext(context)(`ERROR: ${e.message}`);
  }
...
async function commandClearUserConfig(message, command, subcommand, context) {
  try {
    await DATABASE.put(context.SHARE_CONTEXT.configStoreKey, JSON.stringify({}));
...
async function commandFetchUpdate(message, command, subcommand, context) {
  const current = { ts: ENV.BUILD_TIMESTAMP, sha: ENV.BUILD_VERSION };
  try {
    ...
    const timeFormat = (ts) => new Date(ts * 1e3).toLocaleString("en-US", {});
...
async function commandSystem(message, command, subcommand, context) {
  var _a, _b;
  const chatAgent = (_a = loadChatLLM(context)) == null ? void 0 : _a.name;
  const imageAgent = (_b = loadImageGen(context)) == null ? void 0 : _b.name;
  const agent = { AI_PROVIDER: chatAgent, AI_IMAGE_PROVIDER: imageAgent };
...
async function handleCommandMessage(message, context) {
  if (ENV.DEV_MODE) {
    commandHandlers["/echo"] = { help: "[DEBUG ONLY] echo message", scopes: ["all_private_chats", "all_chat_administrators"], fn: commandEcho, needAuth: commandAuthCheck.default };
  }
...
async function bindCommandForTelegram(token) {
  const scopeCommandMap = { all_private_chats: [], all_group_chats: [], all_chat_administrators: [] };
  ...
  for (const scope in scopeCommandMap) {
    result[scope] = await fetch(`https://api.telegram.org/bot${token}/setMyCommands`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ commands: scopeCommandMap[scope].map((command) => ({ command, description: ENV.I18N.command.help[command.substring(1)] || "" })), scope: { type: scope } }) }).then((res) => res.json());
  }
  return { ok: true, result };
}
function commandsDocument() {
  return Object.keys(commandHandlers).map((key) => ({ command: key, description: ENV.I18N.command.help[key.substring(1)] }));
}
...
async function msgFilterWhiteList(message, context) {
  ...
  if (context.SHARE_CONTEXT.chatType === "private") {
    if (!ENV.CHAT_WHITE_LIST.includes(`${context.CURRENT_CHAT_CONTEXT.chat_id}`)) {
      return sendMessageToTelegramWithContext(context)(`You are not in the white list, please contact the administrator to add you to the white list. Your chat_id: ${context.CURRENT_CHAT_CONTEXT.chat_id}`);
    }
    return null;
  }
  if (CONST.GROUP_TYPES.includes(context.SHARE_CONTEXT.chatType)) {
    ...
    if (!ENV.CHAT_GROUP_WHITE_LIST.includes(`${context.CURRENT_CHAT_CONTEXT.chat_id}`)) {
      return sendMessageToTelegramWithContext(context)(`Your group are not in the white list, please contact the administrator to add you to the white list. Your chat_id: ${context.CURRENT_CHAT_CONTEXT.chat_id}`);
    }
    return null;
  }
  return sendMessageToTelegramWithContext(context)(`Not support chat type: ${context.SHARE_CONTEXT.chatType}`);
}
...
async function msgChatWithLLM(message, context) {
  const params = { message: message.text || message.caption || "" };
...
function loadMessage(body) {
  if (body == null ? void 0 : body.edited_message) {
    throw new Error("Ignore edited message");
  }
  if (body == null ? void 0 : body.message) {
    return body == null ? void 0 : body.message;
  } else {
...
async function handleMessage(token, body) {
  ...
  const handlers = [msgInitChatContext, msgCheckEnvIsReady, msgFilterWhiteList, msgFilterUnsupportedMessage, msgHandleGroupMessage, msgIgnoreOldMessage, msgSaveLastMessage, msgHandleCommand, msgChatWithLLM];
  ...
  async fetch(request, ...args) {
    ...
    for (const [method, regex, handlers, path] of this.routes) {
      ...
      if ((method === reqMethod || method === "ALL") && (match = url.pathname.match(regex))) {
        request.params = (match == null ? void 0 : match.groups) || {};
        request.route = path;
        for (const handler of handlers) {
...
async function bindWebHookAction(request) {
  ...
  for (const token of ENV.TELEGRAM_AVAILABLE_TOKENS) {
    ...
    result[id] = { webhook: await bindTelegramWebHook(token, url).then((res) => res.json()).catch((e) => errorToString(e)), command: await bindCommandForTelegram(token).catch((e) => errorToString(e)) };
  }
...
const main = { async fetch(request, env, ctx) {
  try {
    initEnv(env, i18n);
