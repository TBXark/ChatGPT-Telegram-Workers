...
| CLOUDFLARE_TOKEN          | `null`                 | Cloudflare的Token                               | 你可以在`https://dash.cloudflare.com/profile/api-tokens`中使用`Workers AI (Beta)`模板创建                                                  |
| WORKERS_CHAT_MODEL        | 文字生成模型                 | `@cf/meta/llama-2-7b-chat-int8`                | 具体模型列表可以查看`https://developers.cloudflare.com/workers-ai/models/llm/`                                                            |
